...
// Press Alt+M, and then Mobx devtools opened
// if (chrome.commands) {
//   // electron doesn't support this api
...
chrome.runtime.onConnect.addListener(port => {
  ...
  if (isNumeric(port.name)) {
    ...
    // when prot.name is not a number(content-script), contentScript.js has called chrome.runtime.connect() func
